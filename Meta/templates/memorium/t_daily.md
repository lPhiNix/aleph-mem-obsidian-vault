...
<% tp.file.include("[[c_templater_memorium_daily_frontmatter]]") %>

<% tp.file.include("[[c_templater_memorium_daily_journals_frontmatter]]") %>
...
<% tp.file.include("[[c_metabind_memorium_daily_nav_buttons]]") %>
