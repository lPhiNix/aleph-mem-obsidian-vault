...
# Benchmark: Noetheris Module

> **Purpose:** Tests the Noetheris module theming (`native` + `module` + `noetheris`). Noetheris (`Σ`) is the knowledge module — empirical information, hypotheses, science, learning. Compare colors with other modules.
...
```yaml
cssclasses: [native, module, noetheris]
tags: [benchmark]
```
...
The `noetheris` class sets `--highlight` to the Noetheris accent color via `am-class-native-module-03-noetheris.css`. Noetheris is the knowledge and empirical information module.
