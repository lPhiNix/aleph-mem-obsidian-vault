...
# Benchmark: Kaelithra Module

> **Purpose:** Tests the Kaelithra module theming (`native` + `module` + `kaelithra`). Kaelithra (`Ξ`) is the world module — your personal world: people, places, and time periods significant to your life. Compare colors with other modules.
...
```yaml
cssclasses: [native, module, kaelithra]
tags: [benchmark]
```
...
The `kaelithra` class sets `--highlight` to the Kaelithra accent color via `am-class-native-module-06-kaelithra.css`. Kaelithra represents your personal world — the people and places that shape your life.
