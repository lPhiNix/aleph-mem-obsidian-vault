...
```dataviewjs
await dv.view("Meta/scripts/view/dataview/graph/dataview_memorium_dashboard_contribution_heatmap");
```
...
const dashboard = {
  module: "memorium",
  status: "complete",
  heatmap: await dv.view("Meta/scripts/view/dataview/graph/dataview_memorium_dashboard_contribution_heatmap")
};
```
