/**********************
 * HARKAIVE CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Harkaive
...
const CCONFIG = {
  ...
  // Harkaive dark palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#343a40", "#6c757d", "#868e96", "#adb5bd"],
