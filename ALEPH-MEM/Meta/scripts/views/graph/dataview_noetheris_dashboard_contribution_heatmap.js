/**********************
 * NOETHERIS CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Noetheris
...
const CCONFIG = {
  ...
  // Noetheris green palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#2a5c34", "#4fb862", "#8ce99a", "#b8f0c2"],
