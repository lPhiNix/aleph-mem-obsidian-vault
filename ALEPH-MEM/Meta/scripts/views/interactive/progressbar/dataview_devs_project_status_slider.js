const KEY = "devs-project-status";
const MIN = 1, MAX = 4, STEP = 1;
const LABELS = {"1":"Planning","2":"Active","3":"Paused","4":"Completed"};
...
const container = dv.container.createEl("div", { cls: "devs-status-bar progress-bar-input" });
