/**********************
 * DEVS CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Devs
...
const CCONFIG = {
  ...
  // Devs teal palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#1a5c4a", "#2eb894", "#63e6be", "#a3f0d8"],
