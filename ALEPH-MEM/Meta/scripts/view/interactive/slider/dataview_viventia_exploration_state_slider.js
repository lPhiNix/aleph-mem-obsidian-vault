const KEY = "viventia-exploration-state";
const MIN = 1, MAX = 4, STEP = 1;
const LABELS = {"1":"Pending","2":"Tested","3":"Discarded","4":"Accepted"};
...
const container = dv.container.createEl("div", { cls: "viventia-exploration-state-slider slider-input" });
