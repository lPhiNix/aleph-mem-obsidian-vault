/**********************
 * AETHERNUM CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Aethernum
...
const CCONFIG = {
  ...
  // Aethernum grey palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#495057", "#868e96", "#ced4da", "#e8ebed"],
