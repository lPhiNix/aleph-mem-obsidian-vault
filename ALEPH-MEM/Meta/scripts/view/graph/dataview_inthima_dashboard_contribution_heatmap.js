/**********************
 * INTHIMA CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Inthima
...
const CCONFIG = {
  ...
  // Inthima pink palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#93263a", "#fb4466", "#ff8fa3", "#ecb3be"],
