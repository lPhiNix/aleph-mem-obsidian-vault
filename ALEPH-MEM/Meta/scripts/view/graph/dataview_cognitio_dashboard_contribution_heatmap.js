/**********************
 * COGNITIO CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Cognitio
...
const CCONFIG = {
  ...
  // Cognitio orange palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#7a4a1f", "#e68a2e", "#ffb36b", "#ffd4a8"],
