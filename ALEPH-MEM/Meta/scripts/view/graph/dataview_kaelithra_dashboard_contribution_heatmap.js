/**********************
 * KAELITHRA CONTRIBUTION HEATMAP
 * Heatmap de contribuciones del módulo Kaelithra
...
const CCONFIG = {
  ...
  // Kaelithra violet palette: 0=empty, 1=dark, 2=secondary, 3=primary, 4=highlight
  LEVEL_COLORS: ["#2a2a2a", "#452f73", "#8a5fe6", "#b197fc", "#d4c5fd"],
